...
#define DEVICE_NAME                     "BLE_Tester"                               /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "Callum_Sinclair"                          /**< Manufacturer. Will be passed to Device Information Service. */
